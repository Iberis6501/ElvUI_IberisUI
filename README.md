...
|---|---|---|
| **BigWigs** [Download](https://www.curseforge.com/wow/search?search=bigwigs) | Raid alerts | MonoUI bar layout |
| **Details** [Download](https://www.curseforge.com/wow/search?search=details+damage+meter) | Damage meter | ElvUI Frame Style skin, 4-window layout (Threat / Healing / Damage / Total) |
| **InvenRaidFrames3** [Download](https://www.curseforge.com/wow/addons/inven-raid-frame) | Raid frames | 서약선 raid layout |
| **MRT** [Download](https://www.curseforge.com/wow/addons/method-raid-tools) | Raid helper | Note window, MarksBar enabled, CDs profile (per-spec cooldowns), InviteTool |
| **HidingBar** [Download](https://www.curseforge.com/wow/addons/hidingbar) | Minimap button organizer | Per-character profile |
| **Questie** [Download](https://www.curseforge.com/wow/addons/questie) | Quest helper | Enabled |
| **ShamanPower** [Download](https://www.curseforge.com/wow/addons/shamanpower) | Shaman helper | Enabled |
| **TacoTip** [Download](https://www.curseforge.com/wow/addons/tacotip-gearscore-talents) | Tooltip addon | Enabled |
...
| 애드온 | 종류 | 적용 프로필 |
|---|---|---|
| **BigWigs** [다운로드](https://www.curseforge.com/wow/search?search=bigwigs) | 레이드 경보 | MonoUI 바 레이아웃 |
| **Details** [다운로드](https://www.curseforge.com/wow/search?search=details+damage+meter) | 데미지 미터기 | ElvUI Frame Style 스킨, 4창 구성 (위협수준 / 치유 / 피해 / 총합) |
| **InvenRaidFrames3** [다운로드](https://www.curseforge.com/wow/addons/inven-raid-frame) | 공격대 창 | 서약선 레이드 레이아웃 |
| **MRT** [다운로드](https://www.curseforge.com/wow/addons/method-raid-tools) | 공격대 도우미 | Note 창, MarksBar 사용, CDs 프로필 (전문화별 쿨타임), InviteTool |
| **HidingBar** [다운로드](https://www.curseforge.com/wow/addons/hidingbar) | 미니맵 버튼 정렬 | 캐릭터별 프로필 |
| **Questie** [다운로드](https://www.curseforge.com/wow/addons/questie) | 퀘스트 도우미 | 활성화 |
| **ShamanPower** [다운로드](https://www.curseforge.com/wow/addons/shamanpower) | 주술사 도우미 | 활성화 |
| **TacoTip** [다운로드](https://www.curseforge.com/wow/addons/tacotip-gearscore-talents) | 툴팁 애드온 | 활성화 |
